...
- 2026-07-08: Facebook scheduled-post copy has been moved behind the `automation/social_copy.py` polish gate. The current intended weekly rhythm is 3 polished, unique posts/day at 09:00, 13:00, and 17:00 AEST; `automation/meta_outbox.json` is regenerated from the first 21 calendar rows with `copy_polished=true` before scheduling.
